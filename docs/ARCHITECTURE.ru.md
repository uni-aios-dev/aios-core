...
TUI на базе Ratatui с 5-вкладочной интерактивной компоновкой:
...
**Зона вкладок**: 5 выбираемых вкладок — Обзор | Процессы | Блоки | Метрики | Зависимости
...
**Зона подвала**: подсказки горячих клавиш (q=Выход, 1-5=Вкладка, j/k=Навигация, K=Убийство, U=Выгрузка, L=Загрузка, H=Горячая замена, s=Телеметрия, x=Статус, r=Обновление)
...
Горячие клавиши: `q`=Выход, `1-4`=Вкладка, `j/k`=Навигация, `K`=Убийство процесса, `r`=Обновить, `s`=Запись телеметрии, `x`=Статус системы
