...
- **Тесты**: 16 unit (протокол 4, транспорт 2, исполнитель 1, планировщик 8, конфиг 2) + 9 интеграционных (`tests/scheduling.rs`: двухузловой spawn/kill, round-robin, least-loaded, TCP loopback, failover-перезапуск, управление приоритетом, миграция процессов, пути ошибок миграции, ошибки неизвестного узла/без пиров) + 1 doc-тест.
