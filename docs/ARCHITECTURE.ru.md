...
TUI на базе Ratatui с 6-вкладочной интерактивной компоновкой:
...
**Зона вкладок**: 6 выбираемых вкладок — Обзор | Процессы | Блоки | Метрики | Зависимости | Web
...
**Зона подвала**: подсказки горячих клавиш (q=Выход, 1-6=Вкладка, j/k=Навигация, K=Убийство, U=Выгрузка, L=Загрузка, H=Горячая замена, g=фокус URL, o=Открыть ссылку, s=Телеметрия, x=Статус, r=Обновление)
...
Горячие клавиши: `q`=Выход, `1-6`=Вкладка, `j/k`=Навигация, `K`=Убийство процесса, `r`=Обновить, `s`=Запись телеметрии, `x`=Статус системы, Вкладка Web: `g`=фокус URL, `o`=Открыть ссылку, `Esc`=снять фокус
