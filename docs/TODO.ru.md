...
- [ ] **Веха 3 — вытеснение**: планировщик на таймере с переключением контекста, разделение привилегий ядро/пользователь (ring 0/3).
- [ ] **Веха 4 — IPC**: шина обмена сообщениями с переиспользованием типов `aios_core::ipc_protocol` на стороне ядра.